...
myScreenCapture = "lximage-qt --screenshot"  -- Screen Capture

myBrowser :: String
myBrowser = "qutebrowser :fullscreen "  -- Sets qutebrowser as browser

myMusic :: String
myMusic = "youtube-music" 	-- Sets youtube music as music player

myFile :: String
myFile = "pcmanfm-qt" 	-- File Manager

myCode :: String
myCode = "code"		-- Code Editor
...
myManageHook = composeAll
     ...
     , className =? "youtube-music"   --> doShift ( myWorkspaces !! 7 )
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        , ("M-S-<Return>", spawn "dmenu_run -i -fn 'Inconsolata-8' -p \"Run: \"") -- Dmenu
    ...
    -- KB_GROUP Useful programs to have a keybinding for launch
	    ...
	    , ("M-C-s", spawn (myScreenCapture))
	    , ("M-C-e", spawn (myFile))
    --  , ("M-c", spawn (myCode))
        , ("M-b", spawn (myBrowser ++ " www.google.com"))
        , ("M-M1-h", spawn (myTerminal ++ " -e htop"))
        , ("M-M1-v", spawn (myEditor))
    ...
    -- KB_GROUP Multimedia Keys
        ...
        , ("<XF86HomePage>", spawn "qutebrowser https://github.com/Beta7x")
