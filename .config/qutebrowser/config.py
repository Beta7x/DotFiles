...
c.url.default_page = 'file:///home/beta7x/Web Development/index.html'
...
# Font use in tab selected
# Type: Font
c.fonts.tabs.selected = '9pt "SauceCodePro Nerd Font"'

# Font use in tab unselected
# Type: Font
